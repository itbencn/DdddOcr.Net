...
namespace DdddOcr.Net
{
    public class Global
    {
        public static List<string> OCR_OLD_CHARSET = new List<string>(){"", "掀", "袜", "顧", "徕", "榱", "荪", "浡", "其", "炎", "玉", "恩", "劣", "徽",
                                  "廉", "桂", "拂",
                                  "鳊", "撤",
                                  ...
                                  "铢", "窨",
                                  "設", "⒆"};
        public static List<string> OCR_BETA_CHARSET = new List<string>() { "", "笤", "谴", "膀", "荔", "佰", "电", "臁", "矍", "同", "奇", "芄", "吠", "6",
